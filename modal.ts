export class ConnectModal {
    ...
    constructor(onConnect: (mode: "ser" | "sok") => void) {
        ...
        this.serialButton.addEventListener('click', onConnect.bind(this, "ser"));
        this.socketButton.addEventListener('click', onConnect.bind(this, "sok"));
    ...
    public error(error: string): void {
        this.modal.querySelector<HTMLElement>(".modal-error")!.textContent = error;
    }
}
